...
export const getTeamMembers = async (organizationId, filters = {}) => {
  try {
    ...
    // Get all organization members (backend doesn't support status filtering)
...
export const getPendingInvitations = async (organizationId) => {
  try {
    ...
    // Use the correct backend endpoint for pending invitations
    ...
    // Transform the invitation data to match the expected format
