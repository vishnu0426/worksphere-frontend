...
const TaskSummary = ({ tasks, userRole, loading = false }) => {
    ...
    <div className="bg-white rounded-lg border border-border p-6">
      ...
      <div className="space-y-3">
        ...
        {loading ? (
          <div className="space-y-3">
            {[...Array(3)].map((_, index) => (
              <div key={index} className="flex items-center gap-3 p-3 border border-border rounded-lg animate-pulse">
          ...
          <div className="text-center py-8 text-text-secondary">
            <Icon name="CheckCircle" size={48} className="mx-auto mb-4 text-muted" />
