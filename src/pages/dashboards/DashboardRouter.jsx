...
const DashboardRouter = () => {
  ...
  switch (userRole) {
    ...
    default:
      // No fallback - show error for unknown roles
        ...
        <div className='min-h-screen bg-gray-50 flex items-center justify-center p-4'>
          <div className='max-w-md w-full bg-white rounded-lg shadow-lg p-6 text-center'>
            ...
            <p className='text-gray-600 mb-6'>
              Your account has an invalid role: <strong>{userRole}</strong>. Please contact your organization administrator.
            </p>
            <div className='space-y-3'>
              ...
              <button
                onClick={() => window.location.reload()}
                className='w-full inline-flex items-center justify-center px-4 py-2 bg-gray-600 text-white text-sm font-medium rounded-lg hover:bg-gray-700 transition-colors duration-200'
              >
                Refresh Page
              </button>
            </div>
