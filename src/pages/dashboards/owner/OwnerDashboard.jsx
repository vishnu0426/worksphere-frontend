...
import AdminPermissionsControl from '../../../components/settings/AdminPermissionsControl';
...
const OwnerDashboard = () => {
  ...
  const loadDashboardData = useCallback(async () => {
      try {
        ...
        console.log('Owner Dashboard - Organization ID:', organizationId);
        ...
        if (organizationId) {
          try {
            ...
            projectsResult = await apiService.projects.getAll(organizationId);
          ...
          try {
            ...
            console.log('Combined team members:', teamMembersResult);
        ...
        // and they should check their connection or contact support
        setProjects([]);
        setTeamMembers([]);
        setNotifications([]);
        setNotificationsLoading(false);
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-50 to-blue-50'>
      ...
      <div className='max-w-7xl mx-auto px-6 py-8'>
        ...
        {/* Bottom Section - Tasks, Team, and Admin Controls */}
        ...
        {/* Admin Permissions Control - Owner Only */}
        <div className='mb-8'>
          <AdminPermissionsControl
            organizationId={getCurrentOrganizationId()}
            userRole='owner'
            onPermissionsChange={(updatedSettings) => {
              console.log('Admin permissions updated:', updatedSettings);
