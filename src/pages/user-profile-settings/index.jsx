...
const UserProfileSettings = () => {
  ...
  const handlePersonalInfoSave = async (formData) => {
    try {
      ...
      // Backend returns user profile directly, not wrapped in 'data'
      ...
      // Update the global user profile state for immediate header updates
      const profileUpdates = {
        first_name: updatedUser.first_name,
        last_name: updatedUser.last_name,
        displayName: `${updatedUser.first_name || ''} ${updatedUser.last_name || ''}`.trim(),
