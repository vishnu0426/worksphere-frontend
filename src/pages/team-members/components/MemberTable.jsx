...
import { getUserDisplayName, formatUserRole } from '../../../utils/avatarUtils';
                ...
                <td className="px-4 py-4">
                  <div className="flex items-center space-x-3">
                    <div className="relative">
                      <div className={`w-3 h-3 ${getStatusColor(member.status)} rounded-full border-2 border-white`}></div>
                    </div>
                    <div>
                      <div className="font-medium text-text-primary">{getUserDisplayName(member)}</div>
